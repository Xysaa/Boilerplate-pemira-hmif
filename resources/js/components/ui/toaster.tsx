...
/**
 * SonnerProvider — renders the Sonner portal.
 * Does NOT use usePage(). Safe to place outside Inertia <App>.
 */
...
/**
 * FlashToast — listens to Inertia flash props and fires toasts.
 * Must be rendered INSIDE Inertia <App> (i.e. inside AppLayout).
 */
